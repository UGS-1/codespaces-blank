...
class Codevz_Options {
	...
	public static function css_out( $is_customize_preview = 0, $single_page = 0, $post_id = '' ) {
		...
		if ( apply_filters( 'codevz_responsive_mode', 1 ) ) {
			...
			$lt = $pt = $mm = '';
			$header_css = '.header_1,.header_2,.header_3,.header_5,.fixed_side{display: none !important}.header_4,.cz_before_mobile_header,.cz_after_mobile_header,.Corpse_Sticky.cz_sticky_corpse_for_header_4{display: block !important}';
			...
			// 1024px.
			$dynamic .= $lt ? '@media screen and (max-width:1024px){' . $lt . '}' : '';

			// 768px.
			$dynamic .= '@media screen and (max-width:' . Codevz_Plus::option( 'tablet_breakpoint', '768px' ) . '){' . $pt . $dynamic_tablet . '}';

			// 480px.
			$dynamic .= '@media screen and (max-width:' . Codevz_Plus::option( 'mobile_breakpoint', '480px' ) . '){' . $mm . $rsc3 . $dynamic_mobile . '}';
...
::-moz-selection {background-color: ' . $site_color . ';color: #fff}';
	...
	public static function options( $all = false ) {
		...
		// Theme Options filter for adding more options.
				...
				array(
					...
					'fields' => wp_parse_args( $custom_stylekits, array(
						...
						array(
							...
							'selector' 		=> 'form button:hover,.comment-form button:hover,.cz_btn:hover,.cz_btn_half_to_fill:hover:before, .cz_btn_half_to_fill_v:hover:before,.cz_btn_half_to_fill:hover:after, .cz_btn_half_to_fill_v:hover:after,.cz_btn_unroll_v:after, .cz_btn_unroll_h:after,.cz_btn_fill_up:after,.cz_btn_fill_down:after,.cz_btn_fill_left:after,.cz_btn_fill_right:after,.wpcf7-submit:hover,input[type=submit]:hover,input[type=button]:hover,.button:hover,.cz_header_button:hover,.woocommerce a.button:hover,.woocommerce input.button:hover,.woocommerce #respond input#submit.alt:hover,.woocommerce a.button.alt:hover,.woocommerce button.button.alt:hover,.woocommerce input.button.alt:hover,.woocommerce #respond input#submit:hover, .woocommerce a.button:hover, .woocommerce button.button:hover, .woocommerce input.button:hover, #edd-purchase-button:hover, .edd-submit:hover, [type=submit].edd-submit:hover, .edd-submit.button.blue:hover, .edd-submit.button.blue:focus,.woocommerce #payment #place_order:hover, .woocommerce-page #payment #place_order:hover,.woocommerce div.product form.cart .button:hover,.woocommerce button.button:disabled:hover, .woocommerce button.button:disabled[disabled]:hover, .woocommerce a.button.wc-forward:hover'
						),
						array(
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'background', 'padding', 'margin', 'border' ),
							'selector' 		=> 'div.xtra-cookie-button',
							'dependency' 	=> [ 'cookie', '!=', '' ]
						),
						array(
				...
				array(
					...
					'fields' => [
						...
						array(
							...
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'settings' 		=> array( 'color', 'font-size', 'background', 'border' ),
							'selector' 		=> '.xtra-fixed-mobile-nav a i',
							'dependency' 	=> array( 'mobile_fixed_navigation', '!=', '' )
						),
						array(
							'id' 			=> '_css_mfn_i_hover',
							'type' 			=> 'cz_sk_hidden',
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'selector' 		=> '.xtra-fixed-mobile-nav a:hover i',
							'dependency' 	=> array( 'mobile_fixed_navigation', '!=', '' )
						),
						array(
							'id' 			=> '_css_mfn_title',
						...
						array(
							...
							'type' 			=> 'cz_sk_hidden',
							'setting_args' 	=> [ 'transport' => 'postMessage' ],
							'selector' 		=> '.xtra-fixed-mobile-nav a:hover span',
							'dependency' 	=> array( 'mobile_fixed_navigation', '!=', '' )
						),
				...
				array(
					...
					'fields' => array(
						...
						array(
							...
							'type' 			=> 'cz_sk',
							'title' 		=> esc_html__( 'Handle', 'codevz' ),
