...
class Xtra_Woocommerce {
	...
	public function init() {
		...
		add_action( 'woocommerce_after_shop_loop', [ $this, 'woocommerce_after_shop_loop' ] );
		add_action( 'woocommerce_after_single_product_summary', [ $this, 'woocommerce_after_shop_loop' ] );
	...
	public function woocommerce_after_shop_loop() {
		...
		if ( Codevz_Plus::option( 'woo_quick_view' ) ) {
			...
			echo do_shortcode( '[cz_popup id_popup="xtra_quick_view" id="cz_xtra_quick_view" icon="fa czico-198-cancel" sk_icon="color:#ffffff;"][/cz_popup]' );
