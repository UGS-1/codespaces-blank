	...
	class Codevz_Presets {
		...
		public function presets() {
			...
			if ( ! isset( $_GET['type'] ) ) {
				...
				echo "<link rel='stylesheet' href='" . Codevz_Plus::$url . "wpbakery/" . str_replace( 'cz_', '', $t ) . ".css' media='all' />";

				if ( Codevz_Plus::$is_rtl ) {
					echo "<link rel='stylesheet' href='" . Codevz_Plus::$url . "wpbakery/" . str_replace( 'cz_', '', $t ) . ".rtl.css' media='all' />";
				}

				if ( $t === 'cz_2_buttons' || $t === 'cz_service_box' ) {

					echo "<link rel='stylesheet' href='" . Codevz_Plus::$url . "wpbakery/button.css' media='all' />";

					if ( Codevz_Plus::$is_rtl ) {
						echo "<link rel='stylesheet' href='" . Codevz_Plus::$url . "wpbakery/button.rtl.css' media='all' />";
					}
