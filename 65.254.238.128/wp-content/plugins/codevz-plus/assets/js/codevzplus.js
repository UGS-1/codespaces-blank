		...
		*/
		lightGallery: function( update ) {
			...
			var ex  = '.xtra-disable-lightbox',
				selector = 'div:not(' + ex + ') [data-xtra-lightbox]:not(' + ex + '),div:not(' + ex + ') a[href*="/watch?"]:not(' + ex + '),div:not(' + ex + ') a[href*="vimeo.com/"]:not(' + ex + ')';
			...
			if ( update ) {
				...
				// Each gallery.
				$( '.cz_grid' ).length && $( '.cz_grid' ).each( function( i, x ) {
		...
		sticky_columns: function() {
			...
			$( '.cz_sticky .row > aside, .cz_sticky_col' ).codevzPlus( 'sticky-col', function( x ) {
