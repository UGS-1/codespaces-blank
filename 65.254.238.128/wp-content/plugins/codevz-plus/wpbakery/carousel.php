...
class Codevz_WPBakery_carousel {
	...
	public function out( $atts, $content = '' ) {
		...
		$slick = array(
			...
			'prevArrow'			=> '<button type="button" class="slick-prev" aria-label="Previous"><i class="' . $atts['prev_icon'] . '"></i></button>',
			'nextArrow'			=> '<button type="button" class="slick-next" aria-label="Next"><i class="' . $atts['next_icon'] . '"></i></button>',
			'responsive'		=> array(
  				array(
					'breakpoint'	=> 769,
					'settings'		=> array(
