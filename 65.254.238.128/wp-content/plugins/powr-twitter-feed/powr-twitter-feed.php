<?php
    ...
    */
    ...
    function powr_twitter_feed_options() {
      ...
      echo '<iframe id="powr-twitter-feed" src="https://www.powr.io/wp-create/twitter-feed" frameborder="0" width="100%" height="600px" style="position:absolute; top:0; left:0;z-index: 100;"></iframe>';
      echo '<script>';
      echo 'var ht = window.innerHeight; if(document.getElementById("wpadminbar")){ht -= document.getElementById("wpadminbar").offsetHeight;}';
      echo 'var iframe = document.getElementById("powr-twitter-feed"); iframe.style.height = ht+"px"; iframe.height = ht;';
      echo '</script>';
    }
