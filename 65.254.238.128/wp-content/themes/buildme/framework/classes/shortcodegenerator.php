...
class VP_ShortcodeGenerator
{
	...
	function print_form($attributes)
	{
		...
		<div class="vp-sc-action">
			<button class="vp-sc-insert button"><?php esc_attr_e('insert', 'vp_textdomain'); ?></button>
			<button class="vp-sc-cancel button"><?php esc_attr_e('cancel', 'vp_textdomain') ?></button>
		</div>
		<?php
	}
