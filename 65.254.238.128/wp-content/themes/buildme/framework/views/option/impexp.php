<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php esc_attr_e('Import', 'vp_textdomain') ?>
		</label>
		<div class="description">
			<p><?php esc_attr_e('Import Options', 'vp_textdomain') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
...
<div class="vp-field vp-textarea" data-vp-type="vp-textarea">
	<div class="label">
		<label>
			<?php esc_attr_e('Export', 'vp_textdomain') ?>
		</label>
		<div class="description">
			<p><?php esc_attr_e('Export Options', 'vp_textdomain') ?></p>
		</div>
	</div>
	<div class="field">
		<div class="input">
