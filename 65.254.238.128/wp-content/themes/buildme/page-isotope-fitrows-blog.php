			...
			<div class="parallax-wrapper">
            	<div class="vc_col-sm-12 wpb_column vc_column_container">
                	...
                	<div class="wpb_wrapper isotope">
                        ...
                        ?>
						<div <?php post_class('category-all post-single post-format-'. $ozy_current_post_format . ' post-' . $post_item_size . ' post-type-' . $post_type );?>>                        
						<?php
                            ...
                            <div class="caption" <?php echo $post_type === 'colorbox' ? $overlay_color : ''; ?>>
								...
								echo '<'. $heading_size .' class="post-title">';
									echo '<a href="'. esc_url(get_permalink()) .'" title="'. esc_attr(get_the_title()) .'" class="a-page-title" rel="bookmark" '. $title_color .'>'. ( get_the_title() ? get_the_title() : get_the_time('F j, Y') ) .'</a>';
								echo '</'. $heading_size .'>';
