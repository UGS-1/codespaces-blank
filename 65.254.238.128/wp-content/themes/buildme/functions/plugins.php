...
*/
function buildme_register_required_plugins() {
	...
	$plugins = array(
		array(
			...
			'name'     	=> 'BuildMe Essentials',
			'slug'     	=> 'ozy-buildme-essentials',
			'source'   	=> get_template_directory() . '/plugins/ozy-buildme-essentials.zip',
			'required' 	=> true,
			'version'	=> '1.8'
		),array(
			'name'     	=> 'Master Slider',
	...
	$config = array(
		...
		'strings'      		=> array(
			'page_title'                       	=> esc_attr__( 'Install Required Plugins', 'vp_textdomain' ),
			'menu_title'                       	=> esc_attr__( 'Install Plugins', 'vp_textdomain' ),
			'installing'                       	=> esc_attr__( 'Installing Plugin: %s', 'vp_textdomain' ), // %1$s = plugin name
			'oops'                             	=> esc_attr__( 'Something went wrong with the plugin API.', 'vp_textdomain' ),
			...
			'return'                           	=> esc_attr__( 'Return to Required Plugins Installer', 'vp_textdomain' ),
			'plugin_activated'                 	=> esc_attr__( 'Plugin activated successfully.', 'vp_textdomain' ),
			'complete' 							=> esc_attr__( 'All plugins installed and activated successfully. %s', 'vp_textdomain' ), // %1$s = dashboard link
...
add_action('tgmpa_register', 'buildme_register_required_plugins');
