...
class OZY_Filedownload_Widget extends WP_Widget {
	...
	function OZY_Filedownload_Widget() {
		$widget_ops = array( 'classname' => 'filedownload', 'description' => esc_attr__('This widget will help you to display download links with icons.', 'vp_textdomain') );		
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'filedownload-widget' );		
		parent::__construct( 'filedownload-widget', esc_attr__('(BuildMe) File Download Box', 'vp_textdomain'), $widget_ops, $control_ops );
	}
	...
	function icon_list($initial_key = '') {
		$icons = array(
			'gen' => esc_attr__('Generic', 'vp_textdomain'),
			'mp3' => esc_attr__('Audio', 'vp_textdomain'),
			'mov' => esc_attr__('Movie', 'vp_textdomain'),
			'doc' => esc_attr__('Word', 'vp_textdomain'),
			'pdf' => esc_attr__('Acrobat', 'vp_textdomain'),
			'xls' => esc_attr__('Excel', 'vp_textdomain'),
			'zip' => esc_attr__('Compressed', 'vp_textdomain'),
			'mdb' => esc_attr__('Access', 'vp_textdomain')
		);
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><?php esc_attr_e('Title:', 'vp_textdomain'); ?></label>
			<input id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" value="<?php echo esc_attr($instance['title']); ?>" style="width:100%;" />
		</p>
        
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'icon1' )); ?>"><?php esc_attr_e('File #1:', 'vp_textdomain'); ?></label>
            ...
            <label for="<?php echo esc_attr($this->get_field_id( 'title1' )); ?>"><?php esc_attr_e('Caption:', 'vp_textdomain'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'icon2' )); ?>"><?php esc_attr_e('File #2:', 'vp_textdomain'); ?></label>
            ...
            <input type="button" value="..." class="upload-image-button"/>
            <label for="<?php echo esc_attr($this->get_field_id( 'title2' )); ?>"><?php esc_attr_e('Caption:', 'vp_textdomain'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'icon3' )); ?>"><?php esc_attr_e('File #3:', 'vp_textdomain'); ?></label>
            ...
            <input type="button" value="..." class="upload-image-button"/>
            <label for="<?php echo esc_attr($this->get_field_id( 'title3' )); ?>"><?php esc_attr_e('Caption:', 'vp_textdomain'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'icon4' )); ?>"><?php esc_attr_e('File #4:', 'vp_textdomain'); ?></label>
            ...
            <input type="button" value="..." class="upload-image-button"/>
            <label for="<?php echo esc_attr($this->get_field_id( 'title4' )); ?>"><?php esc_attr_e('Caption:', 'vp_textdomain'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'icon5' )); ?>"><?php esc_attr_e('File #5:', 'vp_textdomain'); ?></label>
            ...
            <input type="button" value="..." class="upload-image-button"/>
            <label for="<?php echo esc_attr($this->get_field_id( 'title5' )); ?>"><?php esc_attr_e('Caption:', 'vp_textdomain'); ?></label>
...
class OZY_Testimonial_Widget extends WP_Widget {
	...
	function OZY_Testimonial_Widget() {
		$widget_ops = array( 'classname' => 'testimonial', 'description' => esc_attr__('This widget will help you to display a testimonial box.', 'vp_textdomain') );		
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'testimonial-widget' );		
		parent::__construct( 'testimonial-widget', esc_attr__('(BuildMe) Testimonial Box', 'vp_textdomain'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'content' )); ?>"><?php esc_attr_e('Content:', 'vp_textdomain'); ?></label>
...
class OZY_CustomMenu_Widget extends WP_Widget {
	...
	function OZY_CustomMenu_Widget() {
		$widget_ops = array( 'classname' => 'custommenu', 'description' => esc_attr__('This widget will display custom menu from selected menu.', 'vp_textdomain') );
		
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'custommenu-widget' );
		
		parent::__construct( 'custommenu-widget', esc_attr__('(BuildMe) Custom Menu', 'vp_textdomain'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		//Set up some default widget settings.
		$defaults = array( 'title' => esc_attr__('Custom Menu', 'vp_textdomain'), 'active_menu' => '' );
		$instance = wp_parse_args( (array) $instance, $defaults ); ?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'active_menu' )); ?>"><?php esc_attr_e('Menu:', 'vp_textdomain'); ?></label>
			<?php
...
class OZY_LatestPosts_Widget extends WP_Widget {
	...
	function OZY_LatestPosts_Widget() {
		$widget_ops = array( 'classname' => 'latestposts', 'description' => esc_attr__('This widget will display latest posts in multiple view modes.', 'vp_textdomain') );
		
		$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'latestposts-widget' );
		
		parent::__construct( 'latestposts-widget', esc_attr__('(BuildMe) Latest Posts', 'vp_textdomain'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		//Set up some default widget settings.
		$defaults = array( 'title' => esc_attr__('Latest Posts', 'vp_textdomain'), 'type' => 'list_with_thumbs', 'post_type' => 'post', 'order' => 'ASC', 'orderby' => 'title', 'post_per_page' => 6 );
		$instance = wp_parse_args( (array) $instance, $defaults ); ?>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'type' )); ?>"><?php esc_attr_e('Type:', 'vp_textdomain'); ?></label>
			<?php
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'post_type' )); ?>"><?php esc_attr_e('Post Type:', 'vp_textdomain'); ?></label>
			<?php
				$args = array(
				   'public'   => true,
				   '_builtin' => false
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'order' )); ?>"><?php esc_attr_e('Order:', 'vp_textdomain'); ?></label>
			<?php
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'orderby' )); ?>"><?php esc_attr_e('Order By:', 'vp_textdomain'); ?></label>
			<?php
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'post_per_page' )); ?>"><?php esc_attr_e('Count:', 'vp_textdomain'); ?></label>
...
class OZY_Flickr_Widget extends WP_Widget {
	function OZY_Flickr_Widget() {
		parent::__construct('flickr_widget', '(BuildMe) Flickr Widget', array('classname' => 'flickr', 'description' => esc_attr__('(BuildMe) Flickr Widget for user photo stream!', 'vp_textdomain')), array('id_base' => 'flickr_widget'));
		}
	...
	function widget($args, $instance)
	{
		...
		if($user_name && $number) {
			...
			if($user_name) {
				...
				echo '<p>'. esc_attr__('Invalid flickr user ID.', 'vp_textdomain') .'</p>';
			}
		}
		if($under_text!=''){
