...
?>
	<div id="sidebar" class="<?php echo esc_attr($ozy_data->_page_content_css_name); echo esc_attr($ozy_data->blog_has_super_header ? ' has-super-header' : ''); ?>">
		<ul>
                ...
                <div class="wpb_wrapper">
                    ...
                    <div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
                        ...
                        <article>
                            ...
                            if('gallery' === $ozy_current_post_format) {
                                ...
                                the_content('<p>' . esc_attr__('READ MORE &rarr;', 'vp_textdomain') . '</p>');
                            }
                    ...
                    <div id="post-author">
                        ...
                        <div id="authorDescription">
                            <h3><?php esc_attr_e('About ', 'vp_textdomain'); the_author_posts_link() ?></h3>
                    ...
                    <div class="clear"></div> 
                    <?php 
                        if( ozy_get_option('page_blog_comment') == '1' && comments_open()) { 
