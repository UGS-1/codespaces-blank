<?php 
	...
	if ( $cf7 ) {
		...
		if ( $cf7 ) {
			echo '<i class="' . esc_attr( Codevz_Theme::option( 'cf7_beside_backtotop_icon', 'fa fa-envelope-o' ) ) . ' fixed_contact">' . ( Codevz_Theme::$preview ? '<i class="xtra-section-focus fas fa-cog" data-section="footer_more"></i>' : '' ) . '</i>';
