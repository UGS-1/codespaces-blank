...
if ( ! class_exists( 'Xtra_Dashboard' ) ) {
			...
			?>
				...
				<div class="cz_top_info">
					...
					<div class="cz_theme_name">
						<h2> <?php echo sprintf( 'Welcome to %s WordPress Theme', esc_html( Codevz_Theme::option( 'white_label_theme_name', 'XTRA' ) ) ); ?> </h2>
						<h3 style="opacity:.5"> <?php esc_html_e( 'Current version:', 'xtra' ); ?> <?php echo esc_html( $xtra->get( 'Version' ) ); ?></h3>
					</div>
				</div>

				<h2 class="nav-tab-wrapper">
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=' . self::$slug ) ); ?>" class="nav-tab <?php echo ($page =='welcome' ? 'nav-tab-active' : '') ; ?>">
						<?php esc_html_e( 'Welcome', 'xtra' ); ?>
					</a>
					...
					<?php if ( ! TGM_Plugin_Activation::get_instance()->is_tgmpa_complete() ) { ?>
						<a href="<?php echo esc_url( admin_url( 'themes.php?page=tgmpa-install-plugins' ) ); ?>" class="nav-tab">
							<?php esc_html_e( 'Install Plugins', 'xtra' ); ?>
						</a>
					<?php } ?>
					...
					<?php if ( ! is_array( get_option( self::$activation ) ) || ! $is_plugin_active ) { ?>
						<a href="#" class="nav-tab cz_not_act">
							...
							<?php esc_html_e('Demo Importer', 'xtra'); ?>
						</a>
						<a href="#" class="nav-tab cz_not_act">
							<img src="data:image/svg+xml;utf8;base64," />
							<?php esc_html_e('Theme Options', 'xtra'); ?>
						</a>
					<?php } else { ?>
					...
					<a href="<?php echo esc_url( admin_url( 'admin.php?page=codevz-doc' ) ); ?>" class="nav-tab <?php echo ($page =='doc' ? 'nav-tab-active' : '') ; ?>">
						<?php esc_html_e('Documentation & Support', 'xtra'); ?>
					</a>
				</h2>
			<?php
		}
	...
	.xtra-renew a {
		...
		public function admin_menu() {
			...
			// Sub menus
			add_submenu_page( self::$slug, esc_html__( 'Welcome', 'xtra' ), esc_html__( 'Welcome', 'xtra' ), 'manage_options', self::$slug, [ $this, 'welcome' ] );
			
			if ( ! TGM_Plugin_Activation::get_instance()->is_tgmpa_complete() ) {
				add_submenu_page( self::$slug, esc_html__( 'Install plugins', 'xtra' ), esc_html__( 'Install plugins', 'xtra' ), 'edit_theme_options', 'themes.php?page=tgmpa-install-plugins' );
			}

			$is_plugin_active = is_plugin_active( 'codevz-plus/codevz-plus.php' );

			if ( is_array( get_option( self::$activation ) ) && $is_plugin_active ) {
				add_submenu_page( self::$slug, esc_html__( 'Demo importer', 'xtra' ), esc_html__( 'Demo importer', 'xtra' ), 'edit_theme_options', 'customize.php?&autofocus[panel]=codevz_theme_options-demos' );
				add_submenu_page( self::$slug, esc_html__( 'Theme options', 'xtra' ), esc_html__( 'Theme options', 'xtra' ), 'manage_options', 'customize.php' );
			}

			add_submenu_page( self::$slug, esc_html__( 'Documentation & support', 'xtra' ), esc_html__( 'Documentation & support', 'xtra' ), 'manage_options', 'codevz-doc',[ $this, 'doc' ] );
		}
			...
			<div class="wrap">
				...
				<div class="cz_box cz_box2">
					...
					<div class="cz_faq">
						...
						<div class="cz_a">
							<p>Please read this: <a href="https://xtratheme.com/docs/how-to/automatic-updates/" target="_blank">http://theme.support/doc/xtra#update</a></p>
						</div>
					</div>
				...
				<div class="cz_box cz_box4 cz_box_end">
					...
					<ul class="cz_ula">
						<li><a href="https://xtratheme.com/docs/getting-started/how-to-install-xtra-wordpress-theme/" target="_blank">Installation</a></li>
						<li><a href="https://xtratheme.com/docs/getting-started/importing-demo-content/" target="_blank">Demo Importer</a></li>
						<li><a href="https://xtratheme.com/docs/" target="_blank">Installation Troubleshooting</a></li>
						<li><a href="https://xtratheme.com/docs/how-to/automatic-updates/" target="_blank">Update Guide</a></li>
						<li><a href="https://xtratheme.com/docs/demos-edit-guide/" target="_blank">Demos Edit Guide</a></li>
						<li><a href="https://xtratheme.com/docs/how-to/how-to-change-site-colors/" target="_blank">Theme Color</a></li>
						<li><a href="https://xtratheme.com/docs/" target="_blank">FAQ</a></li>
					</ul>

					<a class="cz_button cz_button_a" target="_blank" href="https://xtratheme.com/docs/"><i class="fa fa-file-text-o"></i>Documentation</a>
		...
		public function welcome() {
			...
			?>
						...
						if ( is_array( get_option( self::$activation ) ) ) {
							...
							if ( isset( $details['purchase_code'] ) ) {
								...
								if ( current_time( 'timestamp' ) > strtotime( $edate ) ) {
									$renew = '<span class="xtra-renew"><a href="https://xtratheme.com/pricing/extended-support/" target="_blank">Buy Extended Support</a></span>';
								}

								echo '<ul class="cz_ul_details">';
								echo '<li><span>Purchase code:</span> <br />' . str_replace( substr( $details['purchase_code'], -12, 10 ), '************', $details['purchase_code'] ) . '</li>';
				...
				<div class="cz_box cz_box2 cz_box_end">
					...
					<h2> System Status </h2>
					<ul class="cz_ul">
						<li>PHP version: <?php echo PHP_VERSION . ( ( version_compare( PHP_VERSION, '7.0.0') <= 0 ) ? '<span class="cz_error">' . esc_html__( 'PHP 7.2 recommended', 'xtra' ) . '</span>' : '<span class="cz_good">' . esc_html__( 'Good', 'xtra' ) . '</span>' ); ?></li>
						<li>Memory limit: <?php echo ini_get( 'memory_limit' ) . ( ( (int) ini_get( 'memory_limit' ) < 128 && ini_get( 'memory_limit' ) != '-1' ) ? '<span class="cz_error">' . esc_html__( '128M recommended', 'xtra' ) . '</span>' : '<span class="cz_good">' . esc_html__( 'Good', 'xtra' ) . '</span>' ); ?></li>
						<li>Max execution time: <?php echo ini_get( 'max_execution_time' ) . ( ( ini_get( 'max_execution_time' ) < 30 ) ? '<span class="cz_error">' . esc_html__( '60 recommended', 'xtra' ) . '</span>' : '<span class="cz_good">' . esc_html__( 'Good', 'xtra' ) . '</span>' ); ?></li>
					</ul>
				</div>
