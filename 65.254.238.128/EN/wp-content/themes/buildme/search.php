                	...
                	<div>
                        ...
                        ?>
                                    <article class="result">
                                        <?php if ( has_post_thumbnail() ) { echo '<a href="'. esc_url(get_permalink()) .'">'; the_post_thumbnail('showbiz'); echo '</a>'; } ?>
                        ...
                        <div class="no-results">
                            <h2><?php esc_attr_e('No Results', 'vp_textdomain'); ?></h2>
                            <p><?php esc_attr_e('Please feel free try again!', 'vp_textdomain'); ?></p>
