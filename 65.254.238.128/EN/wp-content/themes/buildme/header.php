...
<body <?php body_class(); ?>>
    ...
    ?>        
    <div class="none">
        <p><a href="#content"><?php esc_attr_e('Skip to Content', 'vp_textdomain'); ?></a></p><?php /* used for accessibility, particularly for screen reader applications */ ?>
    </div><!--.none-->
    <?php
    ...
    <div id="main" class="<?php echo esc_attr($ozy_data->header_slider[0] !='' ? ' header-slider-active' : ''); echo esc_attr($ozy_data->footer_slider[0] !='' ? ' footer-slider-active' : ''); ?>">
        <?php
