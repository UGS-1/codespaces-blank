<?php
VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_list_wp_menus');

function vp_bind_ozy_buildme_list_wp_menus($value) {
	$result = array(
		array('value' => '-1', 'label' => esc_attr__('-Use Generic-', 'vp_textdomain'))		
	);
...
VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_project_categories_simple');

function vp_bind_ozy_buildme_project_categories_simple() {

	$arr = get_terms( 'project_category', array('hide_empty' => false ) );
	$result = array();
	foreach ($arr as $item)
	{
...
VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_project_categories');

function vp_bind_ozy_buildme_project_categories() {

	$arr = get_terms( 'project_category', array('hide_empty' => false ) );
	$result = array(array('value' => '-1', 'label' => esc_attr__('All', 'vp_textdomain')));
	foreach ($arr as $item)
	{
		if(isset($item->name) && $item->term_id) $result[] = array('value' => $item->term_id, 'label' => $item->name);
	}
...
VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_project_categories_shortcode');

function vp_bind_ozy_buildme_project_categories_shortcode() {

	$arr = get_terms( 'project_category', array('hide_empty' => false ) );
	$result = array(esc_attr__('All', 'vp_textdomain') => '-1');
	foreach ($arr as $item)
	{
...
VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_sidebars');

function vp_bind_ozy_buildme_sidebars() {
...
VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_pages');

function vp_bind_ozy_buildme_pages() {
...
VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_image_gallery_categories');

function vp_bind_ozy_buildme_image_gallery_categories() {
...
VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_image_gallery_categories_raw');

function vp_bind_ozy_buildme_image_gallery_categories_raw() {
...
VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_video_gallery_categories');

function vp_bind_ozy_buildme_video_gallery_categories() {
...
VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_blog_categories');

function vp_bind_ozy_buildme_blog_categories() {
...
VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_revolution_slider');

function vp_bind_ozy_buildme_revolution_slider() {

	$result = array();
	
	if(is_plugin_active("revslider/revslider.php")) {
		
		$result[] = array('value' => '-1', 'label' => esc_attr__('-Not in Use-', 'vp_textdomain'));
		...
		$result[] = array('value' => '-1', 'label' => esc_attr__('-Revolution Slider is not activated-', 'vp_textdomain'));
	}

	return $result;
}

VP_Security::instance()->whitelist_function('vp_bind_ozy_buildme_master_slider');

function vp_bind_ozy_buildme_master_slider() {
	...
	if(is_plugin_active("masterslider/masterslider.php")) {
		...
		$result[] = array('value' => '-1', 'label' => esc_attr__('-Master Slider is not activated-', 'vp_textdomain'));
	}
